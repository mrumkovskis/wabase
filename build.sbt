...
val mojozV    = "6.0.0-RC4-SNAPSHOT"
val quereaseV = "8.0.0-RC6-SNAPSHOT"
val tresqlV   = "13.0.0-RC3-SNAPSHOT"
...
lazy val commonSettings = Seq(
  ...
  libraryDependencies ++= {
    ...
    Seq(
      ...
      "org.bouncycastle"            % "bcprov-jdk18on"        % "1.82"              % Optional,
      "org.bouncycastle"            % "bcpkix-jdk18on"        % "1.82"              % Optional,
      ...
      "io.swagger.core.v3"          % "swagger-jaxrs2-jakarta"% "2.2.39"            % Optional,
      "org.xhtmlrenderer"           % "flying-saucer-pdf"     % "9.12.1"            % Optional,
